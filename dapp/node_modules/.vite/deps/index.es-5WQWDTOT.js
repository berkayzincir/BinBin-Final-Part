...
var require_tslib = __commonJS({
  "node_modules/tslib/tslib.js"(exports, module) {
    ...
    (function(factory) {
      ...
      __createBinding = function(o, m3, k3, k22) {
        if (k22 === void 0)
          k22 = k3;
        o[k22] = m3[k3];
      };
      ...
      __asyncGenerator = function(thisArg, _arguments, generator) {
        ...
        var g3 = generator.apply(thisArg, _arguments || []), i2, q5 = [];
          ...
          if (g3[n2])
            i2[n2] = function(v) {
              return new Promise(function(a2, b4) {
                q5.push([n2, v, a2, b4]) > 1 || resume(n2, v);
              });
            };
        }
      ...
      __asyncDelegator = function(o) {
        ...
        function verb(n2, f3) {
          i2[n2] = o[n2] ? function(v) {
            return (p4 = !p4) ? { value: __await(o[n2](v)), done: n2 === "return" } : f3 ? f3(v) : v;
          } : f3;
        }
      };
...
var hr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events5.EventEmitter(), this.name = it2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = 1e4, this.publish = async (i2, s, n2) => {
...
var _t2 = class extends d {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new cr(), this.events = new import_events5.EventEmitter(), this.name = lt2, this.version = dt2, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = x2, this.subscribeTimeout = 1e4, this.restartInProgress = false, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
...
var zt = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = pt2, this.version = Dt2, this.events = new import_events5.default(), this.initialized = false, this.storagePrefix = x2, this.ignoredPayloadTypes = [U], this.registeredMethods = [], this.init = async () => {
...
var Nt = class extends h {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = yt, this.version = bt, this.cached = [], this.initialized = false, this.storagePrefix = x2, this.init = async () => {
...
var Ut2 = class extends E {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = mt2, this.version = ft2, this.cached = [], this.initialized = false, this.storagePrefix = x2, this.init = async () => {
...
var J2 = class extends n {
  constructor(e) {
    super(e), this.protocol = he, this.version = Ge, this.name = G2, this.events = new import_events5.EventEmitter(), this.initialized = false, this.on = (i2, s) => this.events.on(i2, s), this.once = (i2, s) => this.events.once(i2, s), this.off = (i2, s) => this.events.off(i2, s), this.removeListener = (i2, s) => this.events.removeListener(i2, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || ue2;
    ...
    super(r), this.name = ie2, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [U], this.init = async () => {
      ...
      try {
        const s = this.client.core.pairing.pairings.get(e.pairingTopic), t = this.client.core.pairing.pairings.getAll().filter((i2) => {
          var n2, a2;
          return ((n2 = i2.peerMetadata) == null ? void 0 : n2.url) && ((a2 = i2.peerMetadata) == null ? void 0 : a2.url) === e.peer.metadata.url && i2.topic && i2.topic !== s.topic;
        });
        if (t.length === 0)
          return;
...
var $3 = class extends b2 {
  constructor(r) {
    super(r), this.protocol = j2, this.version = k2, this.name = b3.name, this.events = new import_events6.EventEmitter(), this.on = (s, t) => this.events.on(s, t), this.once = (s, t) => this.events.once(s, t), this.off = (s, t) => this.events.off(s, t), this.removeListener = (s, t) => this.events.removeListener(s, t), this.removeAllListeners = (s) => this.events.removeAllListeners(s), this.connect = async (s) => {
      try {
...
var lr2 = class {
  constructor(u4) {
    this.events = new import_events8.default(), this.rpcProviders = {}, this.shouldAbortPairingAttempt = false, this.maxPairingAttempts = 10, this.disableProviderPing = false, this.providerOpts = u4, this.logger = typeof (u4 == null ? void 0 : u4.logger) < "u" && typeof (u4 == null ? void 0 : u4.logger) != "string" ? u4.logger : (0, import_logger3.pino)((0, import_logger3.getDefaultLoggerOptions)({ level: (u4 == null ? void 0 : u4.logger) || Ca })), this.disableProviderPing = (u4 == null ? void 0 : u4.disableProviderPing) || false;
  }
...
var m2 = class {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = C3(this.rpc.chains), this.signer = await cv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal)
      try {
        const { Web3Modal: s } = await import("./index.es-EFWMY5Q4.js");
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=index.es-5WQWDTOT.js.map
